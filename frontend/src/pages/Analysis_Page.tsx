  ...
  const handleEnterDetails = async () => {
    ...
    try {
      await fetch(`http://localhost:8000/api/articles/${selectedArticle._id}`, {
        ...
        body: JSON.stringify({ ...selectedArticle, title: detailsInput }),
      });
        ...
        {isModalOpen && selectedArticle && (
          <div className="modal" style={modalOverlayStyle}>
            <div className="modal-content" style={modalContentStyle}>
              ...
              <h1 style={{ fontSize: '1.8em' }}><b>{selectedArticle.DOI}</b></h1>
              ...
              <div style={{ marginTop: '20px' }}>
                <button onClick={handleEnterDetails} className="button" style={approveButtonStyle}>Enter</button>
              </div>
            </div>
          </div>
